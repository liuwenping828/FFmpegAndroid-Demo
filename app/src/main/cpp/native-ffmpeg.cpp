...
Java_com_wenping_ffmpegandroid_PlayerNative_play(JNIEnv *env, jclass type, jstring path_,
                                                 jobject view) {
    LOGE("%s", "play()");
 ...
 */
JNIEXPORT void JNICALL
Java_com_wenping_ffmpegandroid_PlayerNative_stop(JNIEnv *env, jclass type) {
